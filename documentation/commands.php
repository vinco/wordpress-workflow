...
$ fab environment:vagrant <strong>wordpress_workflow_upgrade:<span class="args">origin,develop</span></strong>
                       ...
                       <div class="col-lg-12 anchor" id="import_backup" name="import_backup">
                            <h2>import_backup</h2>
                            <p>
                                Import backup generated by backup task.
                            </p>
                            <pre>
$ fab environment:env_name[,debug] <strong>import_backup<span class="args">[:tarball_name]</span></strong>
                            </pre>

                            <h4>Arguments</h4>
                            <ol>
                            <li><strong><span class="args">tarball_name</span></strong> Backup file name.
                                <i>("backup" by default)</i>.</li>
                        </ol>
                            
                            <h4>Examples</h4>
                            <pre>
$ fab environment:vagrant <strong>import_backup</strong>
